...
const PAIRS = [
  ...
  // --- Guess the Watts: the amber accent that gives the game its own identity ---
  ["Game card label on amber tint", INK.amber800, S.amberTint, "text"],
  ["Game card body on amber tint", "#334155", S.amberTint, "text"],
  ["Game card title on amber tint", INK.slate950 ?? "#020617", S.amberTint, "text"],
  ["Game icon badge glyph", INK.amber950, S.amber500, "ui"],
  ["Game Play now button", INK.white, S.amber700, "text"],
  ["Game round label on card", INK.amber700, S.card, "text"],
  ["Game rank on card", INK.amber700, S.card, "text"],
  ["Game points on card", INK.amber700, S.card, "text"],
  ["Game category chip", INK.amber800, INK.amber100, "text"],
  ["Game reveal panel body", "#334155", S.amberTint, "text"],
  ["Game progress fill on card", S.amber600, S.card, "ui"],
  ["Game trophy on card", S.amber600, S.card, "ui"],
  ["Game hero eyebrow on gradient", INK.amber300, "#043a33", "text"],
  ["Game hero CTA ink on panel", INK.amber100, over(INK.amber300, 0.15, "#065f46"), "text"],
